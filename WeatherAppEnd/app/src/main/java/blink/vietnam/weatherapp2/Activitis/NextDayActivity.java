...
public class NextDayActivity extends AppCompatActivity {
    ...
    private void getJsonNextDay(String city) {
        ...
        String url2="https://api.openweathermap.org/data/2.5/forecast/daily?q="+requestCity+"&cnt=7&appid=d77cb61a5967bb592700365acc89844f&units=metric";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < list.length(); i++) {
                                ...
                                String temperStatus = weatherItem.getString("main");
