...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getJsonWeather(String city){
        ...
        final String url="https://api.openweathermap.org/data/2.5/weather?q="+requestCity+"&appid="+API_KEY+"&units=metric";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            } else if("Smoke".equals(temperStatus) || "Mist".equals(temperStatus)) {
                            ...
                            }else if("Rain".equals(temperStatus)){
                                myLayout.setBackgroundResource(R.drawable.skyrain);
                            }else if("Snow".equals(temperStatus)){
